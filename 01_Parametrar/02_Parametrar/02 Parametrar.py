...
# ==========================================================
# 2. Transparent sfär (gemensam domän)
# ==========================================================
...
# ==========================================================
# 3. Hitta högsta koherenspunkter
# ==========================================================
diff = np.sqrt((x_sys[:n]-x_obs)**2 + (y_sys[:n]-y_obs)**2 + (z_sys[:n]-z_obs)**2)
mask = diff < np.percentile(diff, 0.5)  # de mest överlappande punkterna
...
fig.update_layout(
    title="Systemfält och observatörsfält — koherens inom gemensam domän",
    scene=dict(
...
# ==========================================================
fig.show()
outfile = os.path.abspath("Interferens_Sfar_Koherens.html")
